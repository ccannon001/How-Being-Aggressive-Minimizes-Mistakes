...
ep_per_event_table %>%
  gt() %>%
  tab_header(
    title = "EPA per Event with Volume: Interceptions, Sacks, and Sack Fumbles",
    subtitle = "Average EPA Lost per Play and Total Occurrences (NFL 2019–Present)"
  ) %>%
  cols_label(
    season = "Season",
    
    epa_per_interception = "EPA / Interception",
